...
#define SWIGTYPE_p_dex__timestamp_t swig_types[1]
...
#define SWIG_init    Clockkit_Init
#define SWIG_name    "clockkit"
#define SWIG_prefix  ""
...
#endif
SWIGINTERN int
_wrap_ckInitialize(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  if (SWIG_GetArgs(interp, objc, objv,":ckInitialize ") == TCL_ERROR) SWIG_fail;
  ckInitialize();
...
SWIGINTERN int
_wrap_ckTimeAsValue(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  dex::timestamp_t result;
  
  if (SWIG_GetArgs(interp, objc, objv,":ckTimeAsValue ") == TCL_ERROR) SWIG_fail;
  result = ckTimeAsValue();
  Tcl_SetObjResult(interp,SWIG_NewInstanceObj((dex::timestamp_t *)memcpy((dex::timestamp_t *)calloc(1,sizeof(dex::timestamp_t)),&result,sizeof(dex::timestamp_t)), SWIGTYPE_p_dex__timestamp_t, SWIG_POINTER_OWN | 0 ));
  return TCL_OK;
fail:
  return TCL_ERROR;
}
...
SWIGINTERN int
_wrap_ckTimeAsString(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  char *result = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,":ckTimeAsString ") == TCL_ERROR) SWIG_fail;
...
SWIGINTERN int
_wrap_ckInSync(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  bool result;
  
  if (SWIG_GetArgs(interp, objc, objv,":ckInSync ") == TCL_ERROR) SWIG_fail;
...
SWIGINTERN int
_wrap_ckOffset(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  int result;
  
  if (SWIG_GetArgs(interp, objc, objv,":ckOffset ") == TCL_ERROR) SWIG_fail;
  result = (int)ckOffset();
...
static swig_command_info swig_commands[] = {
    { SWIG_prefix "ckInitialize", (swig_wrapper_func) _wrap_ckInitialize, NULL},
    { SWIG_prefix "ckTimeAsValue", (swig_wrapper_func) _wrap_ckTimeAsValue, NULL},
    { SWIG_prefix "ckTimeAsString", (swig_wrapper_func) _wrap_ckTimeAsString, NULL},
    { SWIG_prefix "ckInSync", (swig_wrapper_func) _wrap_ckInSync, NULL},
    { SWIG_prefix "ckOffset", (swig_wrapper_func) _wrap_ckOffset, NULL},
    {0, 0, 0}
};
...
static swig_type_info _swigt__p_dex__timestamp_t = {"_p_dex__timestamp_t", "dex::timestamp_t *", 0, 0, (void*)0, 0};

static swig_type_info *swig_type_initial[] = {
  &_swigt__p_char,
  &_swigt__p_dex__timestamp_t,
};

static swig_cast_info _swigc__p_char[] = {  {&_swigt__p_char, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_dex__timestamp_t[] = {  {&_swigt__p_dex__timestamp_t, 0, 0, 0},{0, 0, 0, 0}};

static swig_cast_info *swig_cast_initial[] = {
  _swigc__p_char,
  _swigc__p_dex__timestamp_t,
};
...
SWIGEXPORT int Clockkit_SafeInit(Tcl_Interp *interp) {
